...
import 'offers_new_drops_model.dart';
export 'offers_new_drops_model.dart';

class OffersNewDropsWidget extends StatefulWidget {
  const OffersNewDropsWidget({super.key});

  @override
  State<OffersNewDropsWidget> createState() => _OffersNewDropsWidgetState();
}

class _OffersNewDropsWidgetState extends State<OffersNewDropsWidget>
    with TickerProviderStateMixin {
  late OffersNewDropsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => OffersNewDropsModel());
