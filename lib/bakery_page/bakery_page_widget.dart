...
import 'bakery_page_model.dart';
export 'bakery_page_model.dart';

class BakeryPageWidget extends StatefulWidget {
  const BakeryPageWidget({super.key});

  @override
  State<BakeryPageWidget> createState() => _BakeryPageWidgetState();
}

class _BakeryPageWidgetState extends State<BakeryPageWidget>
    with TickerProviderStateMixin {
  late BakeryPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => BakeryPageModel());
    ...
    animationsMap.addAll({
      ...
      'iconButtonOnPageLoadAnimation13': AnimationInfo(
        trigger: AnimationTrigger.onPageLoad,
        effectsBuilder: () => [
          FadeEffect(
            curve: Curves.easeInOut,
      ...
      'iconButtonOnPageLoadAnimation14': AnimationInfo(
        trigger: AnimationTrigger.onPageLoad,
        effectsBuilder: () => [
          VisibilityEffect(duration: 1.ms),
          FadeEffect(
      ...
      'iconButtonOnPageLoadAnimation15': AnimationInfo(
        trigger: AnimationTrigger.onPageLoad,
        effectsBuilder: () => [
          FadeEffect(
            curve: Curves.easeInOut,
      ...
      'iconButtonOnPageLoadAnimation16': AnimationInfo(
        trigger: AnimationTrigger.onPageLoad,
        effectsBuilder: () => [
          VisibilityEffect(duration: 1.ms),
          FadeEffect(
          ...
          Column(
            ...
            children: [
              ...
              ClipRRect(
                ...
                child: Image.network(
                  'https://images.unsplash.com/photo-1568254183919-78a4f43a2877?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NTYyMDF8MHwxfHNlYXJjaHwzfHxiYWtlcnl8ZW58MHx8fHwxNzE5NzAwMDA1fDA&ixlib=rb-4.0.3&q=80&w=1080',
                                                        ...
                                                        child:
                                                          ...
                                                          onPressed: () {
                                                            print(
                                                                ...
                                                                animationsMap[
                                                                    'iconButtonOnPageLoadAnimation13']!),
                                                      );
                                                                                                        },
                                                  ),
                                                ],
                                                        ...
                                                        child:
                                                          ...
                                                          onPressed: () {
                                                            print(
                                                                ...
                                                                animationsMap[
                                                                    'iconButtonOnPageLoadAnimation15']!),
                                                      );
                                                                                                        },
                                                  ),
                                                ],
