...
import 'offers40_model.dart';
export 'offers40_model.dart';

class Offers40Widget extends StatefulWidget {
  const Offers40Widget({super.key});

  @override
  State<Offers40Widget> createState() => _Offers40WidgetState();
}

class _Offers40WidgetState extends State<Offers40Widget>
    with TickerProviderStateMixin {
  late Offers40Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Offers40Model());
