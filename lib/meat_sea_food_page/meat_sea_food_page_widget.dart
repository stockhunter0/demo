...
import 'meat_sea_food_page_model.dart';
export 'meat_sea_food_page_model.dart';

class MeatSeaFoodPageWidget extends StatefulWidget {
  const MeatSeaFoodPageWidget({super.key});

  @override
  State<MeatSeaFoodPageWidget> createState() => _MeatSeaFoodPageWidgetState();
}

class _MeatSeaFoodPageWidgetState extends State<MeatSeaFoodPageWidget>
    with TickerProviderStateMixin {
  late MeatSeaFoodPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MeatSeaFoodPageModel());
